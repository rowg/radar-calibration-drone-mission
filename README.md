...
## Background ##
The *APM Planner 2.0* software, which runs on Windows, Mac, and Linux, allows the user to create and edit quadcopter missions and upload them to the vehicle, but it lacks *Mission Planner's* ability to generate the circular arcs needed for CODAR Antenna Pattern Measurements, or "APMs"[^1].
